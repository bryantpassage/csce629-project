...
test_suite/test.exe: test_suite/test.o test_suite/test_functions.o heap.o graph.o graph_algorithms.o naive_queue.o
	$(CC) $(CFLAGS) test_suite/test.o test_suite/test_functions.o heap.o graph.o graph_algorithms.o naive_queue.o -o test_suite/test.exe
